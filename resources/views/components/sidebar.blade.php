            ...
            <ul class="menu">
                ...
                @if (Auth::user()->role == 'admin' || Auth::user()->role == 'material')
                    <li
                        ...
                        <ul class="submenu">
                            ...
                            <li class="submenu-item">
                                <a href="/satuanbarang" class="submenu-link">Satuan</a>
                            </li>
                            <li class="submenu-item">
                ...
                <li
                    ...
                    <ul class="submenu ">
                        @if (Auth::user()->role == 'admin' || Auth::user()->role == 'manager')
                            <li class="submenu-item  ">
                                <a href="/laporanmasuk" class="submenu-link">Laporan Masuk</a>
                            </li>
                        @endif

                        @if (Auth::user()->role == 'admin' || Auth::user()->role == 'manager')
                            <li class="submenu-item  ">
                                <a href="/laporankeluar" class="submenu-link">Laporan Keluar</a>
                            </li>
                        @endif

                        <li class="submenu-item  ">
                            <a href="/stok" class="submenu-link"></i>Stok</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="sidebar-title ">
                    ...
                    <span class="text-capitalize">{{ Auth::user()->name }}<span
                            class="badge bg-primary ms-3">{{ Auth::user()->role }}</span></span>
                </li>
                <li class="sidebar-title ">

                    <a href="/logout" class="underline"><i class="bi bi-box-arrow-right fs-5 me-2"></i>Logout</a>
                </li>
