                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group mandatory">
                                                            ...
                                                            <textarea class="form-control" id="alamat-supplier" name="alamat" rows="3" data-parsley-required="true">{{ $item->alamat }}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group mandatory">
